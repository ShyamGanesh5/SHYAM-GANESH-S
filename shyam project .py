...
appLabel = tk.Label(root, text="Student DataBase System", fg="#06a099", width=50)
...
def destroyRootWindow():
    ...
    secondWindow.title("Check Results")
...
button = tk.Button(root, text="Submit Here", command=lambda :takeNameInput())
button.grid(row=5, column=0, pady=30)

displayButton = tk.Button(root, text="Check Result", command=lambda :destroyRootWindow())
